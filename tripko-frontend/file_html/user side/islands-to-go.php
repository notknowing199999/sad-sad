...
// Fetch tourist spots with town information
$query = "SELECT ts.*, t.name as town_name 
          FROM tourist_spots ts 
          LEFT JOIN towns t ON ts.town_id = t.town_id 
          WHERE ts.status = 'active' AND ts.category = 'Islands'
...
<body>
    ...
    <section class="hero_content">
        <div class="title-row">
            <h1 class="hero_title">Where Every Shore Starts a New Adventure</h1>
        ...
        <div class="scroll-container">
            ...
            ?>
                <div class="no-results">
                    <i class='bx bx-search-alt' style="font-size: 2em; margin-bottom: 10px;"></i>
                    <p>No islands found. Please check back later.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.addEventListener('error', function(e) {
                ...
                loadingOverlay.style.display = 'none'; // Ensure loading overlay is hidden
            });
        });
    </script>
</body>
